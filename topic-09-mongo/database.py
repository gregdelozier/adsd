...
def create_sample_database():
    ...
    pet_collection.insert_many([
        {'name':'Suzy', 'age':3, "kind_id":1, 'owner':'Greg'},
        {'name':'Sandy', 'age':2, "kind_id":2, 'owner':'Steve'},
        {'name':'Dorothy', 'age':1, "kind_id":3, 'owner':'Elizabeth'},
        {'name':'Heidi', 'age':4, "kind_id":1,'owner':'David'}
    ])
